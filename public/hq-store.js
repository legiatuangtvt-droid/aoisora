/**
 * HQ Tasks - Logic for the HQ store task view screen (hq-store.html).
...
(function () {
    ...
    const dom = {
        ...
        // Navigation buttons
        storeScreenBtn: document.getElementById('store-screen'),
        goToHQTasksBtn: document.getElementById('go-to-hq-tasks'),
        goToTaskListBtn: document.getElementById('go-to-task-list'),
        goToCreateTaskBtn: document.getElementById('go-to-create-task'),
        goToStoreListBtn: document.getElementById('go-to-store-list'),
  ...
  anim.onfinish = () => { fly.remove(); collectExp(1); };
    ...
    function setupEventListeners() {
        ...
        if(dom.storeScreenBtn) dom.storeScreenBtn.addEventListener('click', () => redirectTo('index.html'));
        // The hq-tasks button is already on this page, but we keep the listener for consistency.
        if(dom.goToHQTasksBtn) dom.goToHQTasksBtn.addEventListener('click', () => redirectTo('hq-store.html'));
        if(dom.goToTaskListBtn) dom.goToTaskListBtn.addEventListener('click', () => redirectTo('hq-task-list.html'));
        if(dom.goToCreateTaskBtn) dom.goToCreateTaskBtn.addEventListener('click', () => redirectTo('hq-create-task.html'));
        if(dom.goToStoreListBtn) dom.goToStoreListBtn.addEventListener('click', () => redirectTo('hq-store-detail.html'));
