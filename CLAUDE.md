...
│  │  tại Task List      │    │  tại Library Task   │    │  tại To do List     │             │
│  └──────────┬──────────┘    └──────────┬──────────┘    └──────────┬──────────┘             │
│             └──────────────────────────┼──────────────────────────┘                        │
│                                        ▼                                                   │
│                          ┌──────────────────────────┐                                      │
...
│    → overdue: Store quá hạn (end_date < today mà chưa done)                                │
│                                                                                            │
...
│  │ unable              │                                                        │          │
│  ├─────────────────────┼────────────────────────────────────────────────────────┤          │
│  │ any → overdue       │ SYSTEM AUTO: end_date < today VÀ chưa done/unable      │          │
│  └─────────────────────┴────────────────────────────────────────────────────────┘          │
│                                                                                            │
│  ══════════════════════════════════════════════════════════════════════════════════════════│
...
```
┌─────────────────────────────────────────────────────────────────┐
│  TWO CREATION FLOWS - HAI LUỒNG TẠO TASK                        │
│                                                                 │
│  ┌─────────────────────────────────────────────────────────────┐│
│  │  📝 FLOW 1: TẠO TASK TỪ TASK LIST                           ││
│  │  ─────────────────────────────────────────────────────────  ││
...
│  │                                                             ││
│  │  Đặc điểm:                                                  ││
│  │  → Điền thông tin task, KHÔNG chọn Stores (C. Scope hidden) ││
│  │  → Submit để gửi phê duyệt                                  ││
│  │  → Sau khi Approve:                                         ││
...
│     → Draft từ Task List và Draft từ Library là RIÊNG BIỆT     │
│     → Mỗi nơi có giới hạn 5 drafts riêng                       │
│     → Approver duyệt từng loại riêng                           │
│                                                                 │
│  📊 SO SÁNH HAI FLOWS:                                           │
│                                                                 │
│  ┌────────────────┬─────────────────────┬─────────────────────┐ │
│  │ Attribute      │ FLOW 1 (Task List)  │ FLOW 2 (Library)    │ │
│  ├────────────────┼─────────────────────┼─────────────────────┤ │
│  │ Entry Point    │ Task List > Add New │ Library > Add New   │ │
│  │ Route          │ /tasks/new          │ /tasks/library/new  │ │
│  │ C. Scope       │ Required (chọn      │ Hidden (chọn khi    │ │
│  │                │ stores ngay)        │ dispatch sau)       │ │
│  │ After Approve  │ Gửi stores + Lưu    │ Chỉ lưu Library     │ │
│  │                │ Library             │ (chờ dispatch)      │ │
│  │ Draft Limit    │ 5 per user          │ 5 per user (riêng)  │ │
│  │ Use Case       │ Task cần gửi ngay   │ Template dùng lại   │ │
│  └────────────────┴─────────────────────┴─────────────────────┘ │
│                                                                 │
│  💾 DATABASE:                                                    │
│     → tasks table: Chứa task instances (đang thực hiện)         │
│     → task_library table: Chứa task templates (để dùng lại)     │
│     → source: 'task_list' hoặc 'library' (phân biệt nguồn)      │
...
> **Status Value**: `draft`
> **Applies to**: Task (từ Task List) & Template (từ Library) - ĐỘC LẬP
> **Next Status**: `approve` (after Submit)

```
┌─────────────────────────────────────────────────────────────────┐
│  DRAFT STATUS - HAI LUỒNG TẠO ĐỘC LẬP                           │
│                                                                 │
│  ═══════════════════════════════════════════════════════════════│
│  📝 FLOW 1: DRAFT TỪ TASK LIST (có chọn stores)                 │
│  ═══════════════════════════════════════════════════════════════│
│                                                                 │
...
│                                                                 │
│  ═══════════════════════════════════════════════════════════════│
│  📚 FLOW 2: DRAFT TỪ LIBRARY (không chọn stores)                │
│  ═══════════════════════════════════════════════════════════════│
│                                                                 │
...
│                                                                 │
│  ═══════════════════════════════════════════════════════════════│
│  👤 QUYỀN TẠO (Chung cho cả 2 flows):                           │
│  ═══════════════════════════════════════════════════════════════│
...
│        │ A. INFORMATION:                                     │  │
│        │    • Task Type (required)                           │  │
│        │    • Applicable Period (required) - CHỈ FLOW 1      │  │
│        │      ⚠️ Flow 2 (Library): Applicable Period HIDDEN  │  │
│        │      (sẽ điền khi dispatch)                         │  │
│        │    • RE Time (required)                             │  │
│        ├─────────────────────────────────────────────────────┤  │
│        │ B. INSTRUCTIONS:                                    │  │
│        │    • Task Type (required)                           │  │
...
│        ├─────────────────────────────────────────────────────┤  │
│        │ C. SCOPE:                                           │  │
│        │    • FLOW 1 (Task List): All fields required        │  │
...
│  📋 DRAFT RULES:                                                │
│                                                                 │
│     ⚠️ QUAN TRỌNG: Draft từ Task List và Library là ĐỘC LẬP     │
│                                                                 │
...
│        │  ──────────────────────────────────────────────────── ││
│        │  → Tổng cộng user có thể có TỐI ĐA 10 drafts          ││
│        │    (5 từ Task List + 5 từ Library)                    ││
│        │  → Đếm riêng theo source (task_list / library)        ││
│        └───────────────────────────────────────────────────────┘│
