...
| Bottom Row | Task Type + Manual Link + User Icon on same line | "Task type: Image | Manual link: link | [user icon]" |
...
| 2025-12-30 | Task Header layout: Task Type, Manual Link and User Icon now on same bottom row |
