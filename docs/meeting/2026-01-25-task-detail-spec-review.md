...
│                                                                                         │
│ ┌───────────────────────────────────────────────────────────────────────────────────┐   │
│ │ Lvl   │ Task Name                  │ Status      │ Progress │ Stores │ Actions   │   │
│ ├───────┼────────────────────────────┼─────────────┼──────────┼────────┼───────────┤   │
│ │ 1     │ Kiểm kê Q1 2026            │ 🔵 Progress │ 65/150   │ -      │ [View]    │   │
│ │ 1.1   │ ├─ Kiểm kê Thực phẩm       │ 🔵 Progress │ 35/50    │ -      │ [View]    │   │
│ │ 1.1.1 │ │  ├─ Kiểm kê Rau củ       │ ✅ Done     │ 25/25    │ 25     │ [View]    │   │
│ │ 1.1.2 │ │  └─ Kiểm kê Hải sản      │ 🔵 Progress │ 10/25    │ 25     │ [View]    │   │
│ │ 1.2   │ ├─ Kiểm kê Điện máy        │ 🔵 Progress │ 30/50    │ 50     │ [View]    │   │
│ │ 1.3   │ └─ Kiểm kê Thời trang      │ ⚪ Not Yet  │ 0/50     │ 50     │ [View]    │   │
│ └───────┴────────────────────────────┴─────────────┴──────────┴────────┴───────────┘   │
│                                                                                         │
│ 💡 LEGEND:                                                                              │
│    • Stores = "-" → Task CHA (có child tasks, không giao trực tiếp cho stores)         │
│    • Stores = số  → Task LÁ (không có child, giao cho stores)                          │
│                                                                                         │
└─────────────────────────────────────────────────────────────────────────────────────────┘
```
...
**Cách nhận biết nhanh Task Cha vs Task Lá:**

| Cột Stores | Loại Task | Có thể click HQ Check? |
|------------|-----------|------------------------|
| `-` | Task CHA (có child) | ❌ Không |
| Số (25, 50...) | Task LÁ (không có child) | ✅ Có |
...
│ 1.1.1.1 │ │  │  ├─ Rau củ                     │ ✅ Done     │ 25/25    │ 25     │ [View]     │
│ 1.1.1.2 │ │  │  └─ Hải sản                    │ 🔵 Progress │ 10/25    │ 25     │ [View]     │
│ 1.1.2   │ │  ├─ Kiểm kê Điện máy              │ 🔵 Progress │ 30/50    │ 50     │ [View]     │
│ 1.1.3   │ │  └─ Kiểm kê Thời trang            │ ⚪ Not Yet  │ 0/50     │ 50     │ [View]     │
...
│                                                                                         │
│ → [▼] = Expanded (đang mở)                                                              │
│ → [▶] = Collapsed (đang đóng, có child bên trong)                                       │
│ → Không có icon = Leaf task (không có child)                                            │
│                                                                                         │
└─────────────────────────────────────────────────────────────────────────────────────────┘
```
