...
│    • Click vào row để navigate đến Task Detail tương ứng                │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
...
|----------|-----------|------------|
| `-` | Task CHA | Có child tasks, không giao trực tiếp cho stores |
| `25/25`, `30/50` | Task LÁ | Giao trực tiếp cho stores, số done/total |

**Navigation:** Click vào bất kỳ row nào → Navigate đến `/tasks/{task_id}`
...
→ Click vào bất kỳ row → Navigate đến /tasks/{task_id}
```
...
│ └─────────┴──────────────────────────┴─────────────┴──────────┘                         │
│                                                                                         │
│ → [▼] = Expanded (đang mở, hiển thị children bên dưới)                                  │
│ → [▶] = Collapsed (đang đóng, click để mở children)                                     │
│ → Không có icon = Leaf task (không có children)                                         │
│ → Click vào ROW (không phải icon) = Navigate đến Task Detail                            │
│                                                                                         │
└─────────────────────────────────────────────────────────────────────────────────────────┘
```
