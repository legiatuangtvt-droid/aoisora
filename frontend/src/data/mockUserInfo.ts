...
const improvementDepartment: Department = {
  id: 'IMPROVEMENT',
  name: 'IMPROVEMENT',
  icon: 'improvement',  // Inline SVG icon
  iconColor: '#2563EB',
