...
const StoreCard: React.FC<StoreCardProps> = ({ store, onToggle, hasConnector = true }) => {
  return (
    <div className="relative">
      ...
      <div
        className="ml-10 flex items-start justify-between px-4 py-5 bg-white border border-[#9B9B9B] rounded-[10px] cursor-pointer hover:bg-gray-50 transition-colors"
